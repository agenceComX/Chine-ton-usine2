...
const AdminAlertsPage = React.lazy(() => import('./pages/admin/AlertsPage'));
const AdminDatabasePage = React.lazy(() => import('./pages/admin/DatabasePage'));
...
// Composant pour afficher conditionnellement le Footer
