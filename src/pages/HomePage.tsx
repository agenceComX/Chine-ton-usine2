...
const ParticleSystem = React.lazy(() => import('../components/ParticleSystem'));
...
const HomePage: React.FC = () => {
  ...
  const categories = useMemo(() => [
    ...
    { name: t('homepage.categories.machinery'), icon: '⚙️', id: 'machinery' },
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="relative overflow-hidden">
        <div className="relative h-[70vh] min-h-[500px] bg-gradient-to-br from-blue-400 via-blue-600 to-purple-800 flex items-center justify-center">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-blue-600/40 via-blue-500/50 to-purple-600/60 animate-gradient-shift"></div>

          {/* Blobs morphiques décoratifs */}
          <div className="absolute top-20 left-20 w-32 h-32 bg-gradient-to-r from-blue-400 to-orange-400 opacity-30 animate-morphing-blob"></div>
          <div className="absolute bottom-20 right-20 w-24 h-24 bg-gradient-to-r from-orange-400 to-purple-400 opacity-40 animate-morphing-blob" style={{ animationDelay: '3s' }}></div>
          ...
          <svg className="absolute bottom-0 w-full h-full opacity-30 z-10" viewBox="0 0 1200 400" preserveAspectRatio="xMidYMax slice">
            <defs>
              <linearGradient id="mountain1" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" style={{ stopColor: '#4682B4', stopOpacity: 0.8 }} />
                <stop offset="100%" style={{ stopColor: '#191970', stopOpacity: 0.9 }} />
              </linearGradient>
              <linearGradient id="mountain2" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" style={{ stopColor: '#483D8B', stopOpacity: 0.7 }} />
                <stop offset="100%" style={{ stopColor: '#2F1B69', stopOpacity: 0.8 }} />
              </linearGradient>
              <linearGradient id="mountain3" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" style={{ stopColor: '#6495ED', stopOpacity: 0.5 }} />
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-20">
            <div className={`flex items-center mb-4 transform transition-all duration-1000 delay-300 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
              }`}>
              <h1 className="text-6xl font-bold text-white drop-shadow-2xl shadow-black/80 animate-pulse font-display">
                {t('homepage.title')}
              </h1>
              <div className="ml-2 w-4 h-4 bg-orange-400 rounded-sm transform rotate-45 animate-bounce drop-shadow-lg"></div>            </div>
            <div className={`!text-white text-lg mb-2 font-medium tracking-wide transform transition-all duration-1000 delay-500 font-reading text-readable drop-shadow-lg ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
              }`}>
              {t('homepage.subtitle')}
              <span className="bg-orange-500 text-white px-2 py-1 mx-2 rounded font-bold transform -skew-x-12 animate-pulse hover:animate-bounce transition-all font-display drop-shadow-lg">
                {t('homepage.subtitle.highlight')}
              </span>
            </div>
            <p className={`!text-white text-base mb-8 font-medium transform transition-all duration-1000 delay-700 font-reading text-readable drop-shadow-lg ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
              }`}>
              {t('homepage.tagline')}
            </p>

            {/* Barre de recherche */}
            <form onSubmit={handleSearch} className={`relative max-w-md w-full px-4 transform transition-all duration-1000 delay-900 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
              }`}>
              <input
                type="text"
                value={searchQuery}
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2 font-display">
              {t('homepage.categories.section.title')}
            </h3>
            <p className="text-gray-600 dark:text-gray-400 font-reading">
              {t('homepage.categories.section.subtitle')}
            </p>
          </div>
          <div className="overflow-x-auto">              <div className="flex space-x-6 pb-4 min-w-max justify-center">
            {categories.map((category, index) => (
              ...
              >
                <div className={`w-16 h-16 rounded-2xl flex items-center justify-center text-3xl transition-all duration-300 shadow-lg hover:shadow-xl ${index === 0
      ...
      <div className="bg-white dark:bg-gray-900 py-16">
        <div className="max-w-7xl mx-auto px-4">
          <React.Suspense fallback={<div className="text-center py-8">{t('homepage.recommendations.loading')}</div>}>
      ...
      <div className="bg-white dark:bg-gray-900 py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Carte Textile */}
            <div className={`bg-gradient-to-br from-slate-100 via-blue-100 to-indigo-200 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 hover:-rotate-1 cursor-pointer group relative ${visibleCards >= 2 ? 'translate-y-0 opacity-100 scale-100' : 'translate-y-8 opacity-0 scale-95'
              }`}
            ...
            {/* Carte Machinerie */}
            <div className={`bg-gradient-to-br from-green-200 via-emerald-300 to-teal-300 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 hover:rotate-1 cursor-pointer group relative ${visibleCards >= 3 ? 'translate-y-0 opacity-100 scale-100' : 'translate-y-8 opacity-0 scale-95'
              }`}
            ...
            {/* Carte Maison & Jardin */}
            <div className={`bg-gradient-to-br from-orange-200 via-orange-300 to-blue-300 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 hover:-rotate-1 cursor-pointer group relative ${visibleCards >= 4 ? 'translate-y-0 opacity-100 scale-100' : 'translate-y-8 opacity-0 scale-95'
              }`}
            ...
            <div className={`bg-gradient-to-br from-blue-200 via-sky-200 to-cyan-200 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 hover:rotate-1 cursor-pointer group relative ${visibleCards >= 5 ? 'translate-y-0 opacity-100 scale-100' : 'translate-y-8 opacity-0 scale-95'
              }`}
            ...
            {/* Carte Auto & Moto */}
            <div className={`bg-gradient-to-br from-purple-200 via-violet-300 to-indigo-300 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 hover:-rotate-1 cursor-pointer group relative ${visibleCards >= 6 ? 'translate-y-0 opacity-100 scale-100' : 'translate-y-8 opacity-0 scale-95'
              }`}
          ...
          <div className={`mt-20 text-center transform transition-all duration-1000 delay-1500 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0 scale-95'
            }`}><div className="relative inline-block group">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4 relative transition-all duration-300 group-hover:scale-105 font-display">
                {t('homepage.cta.title')}
                <span className="bg-gradient-to-r from-blue-600 to-orange-500 bg-clip-text text-transparent font-bold mx-3 transition-all duration-300 hover:scale-110 font-display drop-shadow-lg shadow-gray-800/20 dark:shadow-white/30">
                  {t('homepage.cta.highlight')}
                </span>
              </h2>
              <div className="absolute -top-2 -right-2 w-4 h-4 bg-orange-400 rounded-sm transform rotate-45 animate-pulse"></div>            </div>
            <p className="text-white text-xl font-semibold mb-8 animate-fade-in-up font-reading text-readable tracking-wide">
              {t('homepage.cta.subtitle')}
            </p>
            {/* Bouton CTA */}
            <div className="mt-8">            <Link to="/products">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="group">
              ...
              <h3 className="text-xl font-bold text-white mb-2 font-display">{t('homepage.benefits.delivery.title')}</h3>
              <p className="text-white/90 font-reading">{t('homepage.benefits.delivery.description')}</p>
            </div>
            <div className="group">
              <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                <Wallet className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-xl font-bold text-white mb-2 font-display">{t('homepage.benefits.payment.title')}</h3>
              <p className="text-white/90 font-reading">{t('homepage.benefits.payment.description')}</p>
            </div>
            <div className="group">
              <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                <Users className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-xl font-bold text-white mb-2 font-display">{t('homepage.benefits.support.title')}</h3>
              <p className="text-white/90 font-reading">{t('homepage.benefits.support.description')}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-900 pt-16 md:pt-24 pb-16 md:pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            <Link to="/register">
              <Button className="bg-gradient-to-r from-blue-600 to-orange-600 hover:from-blue-700 hover:to-orange-700 text-white px-8 py-4 text-lg font-medium rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg">
                {t('homepage.how.cta')}
              </Button>
            </Link>          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <div className="flex items-center text-sm text-gray-600 dark:text-gray-400">
              ...
              <span className="font-reading">{t('homepage.discover.verified')}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-blue-600 via-blue-500 to-orange-500 dark:from-blue-700 dark:via-blue-600 dark:to-orange-600 py-20 md:py-32 min-h-[50vh] flex items-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link to="/register">
            <Button className="bg-blue-600 text-blue-600 hover:bg-blue-50 px-12 py-4 text-xl font-bold rounded-full transition-all duration-300 transform hover:scale-110 hover:-translate-y-2 shadow-2xl hover:shadow-3xl button-pulse font-display">
...
export default HomePage;// Force reload
