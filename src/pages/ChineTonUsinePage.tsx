    ...
    <div className={`min-h-screen ${isDarkMode ? 'bg-gray-900' : 'bg-white'}`}>
      ...
      <header className="relative">        {/* Image de fond montagne avec overlay */}
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-10">            <div className="flex items-center mb-4">
              <h1 className="text-6xl font-bold text-white" style={{ fontFamily: 'serif' }}>
                Chine ton usine
              </h1>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {productCards.map((card) => (            <div
            ...
            >
              {card.badge && (
                <div className="absolute top-4 right-4 bg-red-500 text-white text-xs px-3 py-1 rounded-full z-10 font-semibold">
                  {card.badge}
                </div>
              )}
